...
# YouTube Channel: [YouTube](https://youtube.com/@airdropbombnode)
# Twitter Channel: [Twitter](https://x.com/airdropbombnode)
# If You Want To Run The Bot Make Sure You Mint This NFT First Then Its Run: [NFT](https://bold-adb-node.testnet.nfts2.me/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/airdropbomb/Monad-testnet-Bot.git && cd Monad-testnet-Bot
   ```
